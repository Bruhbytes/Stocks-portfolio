...
const Metrics = () => {
  ...
  const fetchStockData = () => {
    axios
      .post("http://127.0.0.1:5000/stock", { symbol })
      .then((response) => {
  ...
  const fetchSnapshotImage = () => {
    axios
      .get("http://127.0.0.1:5000/snapshot", { responseType: "blob" })
      .then((response) => {
  ...
  const fetchSharpeRatio = () => {
    axios
      .get("http://127.0.0.1:5000/sharpe")
      .then((response) => {
  ...
  const fetchMaxDrawdown = () => {
    axios
      .get("http://127.0.0.1:5000/max_drawdown")
      .then((response) => {
  ...
  const fetchVolatility = () => {
    axios
      .get("http://127.0.0.1:5000/volatility")
      .then((response) => {
  ...
  const fetchVSSYP = () => {
    axios
      .get("http://127.0.0.1:5000/SYP", { responseType: "blob" })
      .then((response) => {
        const imageUrl = URL.createObjectURL(new Blob([response.data]));
        setVSSYP(imageUrl);
      })
